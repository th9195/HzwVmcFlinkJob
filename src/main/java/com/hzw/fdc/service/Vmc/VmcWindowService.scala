...
import com.hzw.fdc.dao.Vmc.VmcWindowDao
...
import com.hzw.fdc.json.JsonUtil.{beanToJsonNode, fromJson}
 ...
 */
class VmcWindowService extends TService {
  private val dao = new VmcWindowDao
