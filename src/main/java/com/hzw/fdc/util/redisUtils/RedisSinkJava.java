 ...
 * support set expire
 */
public class RedisSinkJava extends RichSinkFunction<RedisCommand> {
    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory.getLogger(RedisSinkJava.class);

    private final RedisConfig redisConfig;

    private transient JedisPool jedisPool;

    public RedisSinkJava(RedisConfig redisConfig) {
