...
import com.hzw.fdc.controller.Vmc.{VmcIndicatorController, VmcWindowController}
import com.hzw.fdc.util.{LocalPropertiesConfig, MainFabConstants, ProjectConfig, VmcConstants}
 ...
 */
object VmcIndicatorApplication extends App with TApplication {
  ...
  start({
    val controller = new VmcIndicatorController
    controller.execute()
  }, jobName = VmcConstants.VmcIndicatorJob)
