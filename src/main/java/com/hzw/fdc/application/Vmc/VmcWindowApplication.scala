...
import com.hzw.fdc.controller.Vmc.VmcWindowController
 ...
 * @description VmcWindowApplication
 */
object VmcWindowApplication extends App with TApplication {
  ...
  start({
    val controller = new VmcWindowController
    controller.execute()
  }, jobName = VmcConstants.VmcWindowJob)
