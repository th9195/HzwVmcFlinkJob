...
import com.hzw.fdc.controller.MainFabDataTransformWindowController
...
/**
 * MainFabDataTransformWindowApplication
 *
 * @desc:
 * @author tobytang
 * @date 2022/11/5 11:18
 * @since 1.0.0
 * @update 2022/11/5 11:18
 * */
object MainFabDataTransformWindowApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabDataTransformWindowController
    controller.execute()

  },jobName =  MainFabConstants.DataTransformWindowJob)
