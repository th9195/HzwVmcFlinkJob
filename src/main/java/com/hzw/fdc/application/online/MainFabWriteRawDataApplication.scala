...
import com.hzw.fdc.controller.MainFabWriteRawDataController
import com.hzw.fdc.util.ProjectConfig
import org.apache.flink.api.java.utils.ParameterTool


object MainFabWriteRawDataApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabWriteRawDataController
    controller.execute()

  }, jobName = "MainFabWriteRawDataApplication")
}