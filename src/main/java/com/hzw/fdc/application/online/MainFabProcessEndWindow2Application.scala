...
import com.hzw.fdc.controller.MainFabProcessEndWindow2Controller
import com.hzw.fdc.util.{ LocalPropertiesConfig, MainFabConstants, ProjectConfig}
import org.apache.commons.lang3.SystemUtils
import org.apache.flink.api.java.utils.ParameterTool

/**
 * MainFabLongRunProcessEndWindowApplication
 *
 * @desc:
 * @author tobytang
 * @date 2022/12/13 13:12
 * @since 1.0.0
 * @update 2022/12/13 13:12
 * */
object MainFabProcessEndWindow2Application extends App with TApplication {
  ...
  start({
    val controller = new MainFabProcessEndWindow2Controller
    controller.execute()

  },jobName =  MainFabConstants.ProcessEndWindow2Job)
