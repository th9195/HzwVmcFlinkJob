...
import com.hzw.fdc.controller.MainFabCalculatedIndicatorController
 ...
 *
 */
object MainFabCalculatedIndicatorApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabCalculatedIndicatorController
    controller.execute()
  }, jobName = "MainFabCalculatedIndicatorApplication")
}
