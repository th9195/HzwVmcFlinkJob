...
import com.hzw.fdc.controller.MainFabAlarmWriteResultDataController
import com.hzw.fdc.util.ProjectConfig
import org.apache.flink.api.java.utils.ParameterTool


object MainFabAlarmWriteResultDataApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabAlarmWriteResultDataController
    controller.execute()

  },jobName =  "MainFabAlarmWriteResultDataApplication")
}
