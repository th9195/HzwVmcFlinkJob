...
import com.hzw.fdc.controller.MainFabProcessEndWindowController
...
/**
 * MainFabProcessEndWindowApplication
 *
 * @desc:
 * @author tobytang
 ...
 * */
object MainFabProcessEndWindowApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabProcessEndWindowController
    controller.execute()

  },jobName =  "MainFabProcessEndWindowApplication")
