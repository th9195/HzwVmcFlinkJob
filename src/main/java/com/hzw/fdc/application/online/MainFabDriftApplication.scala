...
import com.hzw.fdc.controller.MainFabDriftController
 ...
 *
 */
object MainFabDriftApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabDriftController
    controller.execute()
  },jobName =  "MainFabDriftApplication")
}
