...
import com.hzw.fdc.controller.MainFabAlarmController
 ...
 *
 */
object MainFabAlarmApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabAlarmController
    controller.execute()
  }, jobName = "MainFabAlarmApplication")
