...
import com.hzw.fdc.controller.{MainFabAlarmController, MainFabWriteRedisDataController}
 ...
 *
 */
object MainFabWriteRedisDataApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabWriteRedisDataController
    controller.execute()
  }, jobName = MainFabConstants.WriteRedisDataJob)
