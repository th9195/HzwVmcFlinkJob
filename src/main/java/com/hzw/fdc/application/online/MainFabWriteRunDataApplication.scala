...
import com.hzw.fdc.controller.MainFabWriteRunDataController
import com.hzw.fdc.util.ProjectConfig
import org.apache.flink.api.java.utils.ParameterTool


object MainFabWriteRunDataApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabWriteRunDataController
    controller.execute()

  },jobName =  "MainFabWriteRunDataApplication")
}