...
import com.hzw.fdc.controller.MainFabRouterController
import com.hzw.fdc.util.ProjectConfig
import org.apache.flink.api.java.utils.ParameterTool


object MainFabRouterApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabRouterController
    controller.execute()

  }, jobName = "MainFabRouterApplication")
}