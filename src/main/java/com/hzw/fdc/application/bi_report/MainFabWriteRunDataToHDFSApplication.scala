...
import com.hzw.fdc.controller.MainFabWriteRunDataToHDFSController
...
/**
  ...
  * @version V1.0
  */
object MainFabWriteRunDataToHDFSApplication extends App with TApplication{
  // todo 1- 获取配置文件的路径
  ...
  start({
    val controller = new MainFabWriteRunDataToHDFSController
    controller.execute()

  },jobName =  "MainFabWriteRunDataToHDFSApplication")
