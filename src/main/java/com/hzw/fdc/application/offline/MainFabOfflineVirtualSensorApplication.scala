...
import com.hzw.fdc.common.TApplication
import com.hzw.fdc.controller.{MainFabOfflineVirtualSensorController, MainFabOfflineWindowController}
import com.hzw.fdc.util.{LocalPropertiesConfig, MainFabConstants, ProjectConfig}
import org.apache.commons.lang3.SystemUtils
import org.apache.flink.api.java.utils.ParameterTool


object MainFabOfflineVirtualSensorApplication extends App with TApplication {
  // todo 1- 获取配置文件的路径
  ...
  start({
  val controller = new MainFabOfflineVirtualSensorController
  controller.execute()

},jobName =  "MainFabOfflineVirtualSensorApplication")
}
