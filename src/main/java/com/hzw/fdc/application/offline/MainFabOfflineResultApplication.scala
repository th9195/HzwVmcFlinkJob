...
import com.hzw.fdc.controller.MainFabOfflineResultController
 ...
 * @version: $
 */
object MainFabOfflineResultApplication extends App with TApplication {
  ...
  start({
    val controller = new MainFabOfflineResultController
    controller.execute()

  },jobName =  "MainFabOfflineResultApplication")
}
